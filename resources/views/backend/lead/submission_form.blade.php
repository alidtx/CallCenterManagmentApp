                ...
                <form action="{{ route('lead.store')}}" method="post" id="formSubmission" >
                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="employee_id" id="employee_id" class="form-control" value="{{@$employees->id}}">
                        <input type="text" id="department_id" class="form-control" value="{{ @$employees->name }}" readonly>
