...
@php
    $favicon = App\Models\Setting::where('key', 'fevicon')->first()->value ?? null;
    $logo = App\Models\Setting::where('key', 'site_logo')->first()->value ?? null;
    $project_name = App\Models\Setting::where('key', 'project_name')->first()->value ?? null;
    #notification
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('home') }}" class="app-brand-link">
                        @if (isset($logo))
                            <img src="{{ asset('storage/' . $logo) }}" alt="EchoReach" width="100px" />
                        @else
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                                    ...
                                    <div class="dropdown-shortcuts-list scrollable-container">
                                        <div class="row row-bordered overflow-visible g-0">
                                            <div class="dropdown-shortcuts-item col">
                                                ...
                                                <small class="text-muted mb-0">Manage Profile</small>
                                            </div>
                                            <div class="dropdown-shortcuts-item col">
                                                <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                                ...
                                                <a href="{{ route('change_password') }}"
                                                    class="stretched-link">Change Password</a>
                                                <small class="text-muted mb-0">Change Password</small>
                                            </div>
                                        </div>
                                        <div class="row row-bordered overflow-visible g-0">
                                            <div class="dropdown-shortcuts-item col">
                            ...
                            <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <span
                                        class="badge bg-danger rounded-pill badge-notifications">{{ $notify_count }}</span>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end py-0">
                                    <li class="dropdown-menu-header border-bottom">
                                        <div class="dropdown-header d-flex align-items-center py-3">
                                            <h5 class="text-body mb-0 me-auto">Notification</h5>
                                            <a href="{{ route('marAllAsRead') }}"
                                        ...
                                        <ul class="list-group list-group-flush">
                                                    ...
                                                    <li
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 me-3">
                                                                <div class="avatar">
                                                                    <img src="{{ asset('assets/img/illustrations/rocket.png') }}"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <p class="mb-0">{{ $notification->data['message'] }}
                                                                </p>
                                                                <small
                                            ...
                                            @else
                                                <li
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1" align="center">No Notification</h6>
                                                        </div>
                                                    </div>
                                                </li>
                                            @endif
                                        ...
                                        <a class="dropdown-item" href="{{ route('profile') }}">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small
                                                        class="text-muted">{{ auth()->user()->roles()->first()->name ?? null }}</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
